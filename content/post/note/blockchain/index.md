...
以下知识基于 18 年的课，部分参数或内容可能经协议修改。

## BTC

一套分布式的、以交易(transaction, tx)账本为核心的、协议。

一个算力网络：各方在协议的机制下，提供着自己的算力。也是所谓挖矿、矿工说法的由来。~~全世界最慢的世界库？~~

其激励机制包括，**出单个区块的奖励** (初值50BTC，每210,000个区块减半，平均 10 分钟出一个，约4年，折半一次) 和**手续费**。

总区块奖励保证一共 2100 W 个比特币。

$$
50 \times 210,000 \times (1 + \frac{1}{2}+ \frac{1}{4} + ...) = 50 \times 210,000  \times 2 = 21,000,000
$$

BTC 开户 -> 只需有一对本地的私钥公钥对，有一个好的随机元即可。
